export const data = {
    ...
    "slider": [
        {
            "image": require("../images/slider1/1.jpg"),
            "title": "Plus Loin Ensemble",
            "subtitle": "Le futur et toutes les raisons d y croire"
        },
        {
            "image": require("../images/slider1/2.jpg"),
            "title": "Prêt à relever des défis ?",
            "subtitle": "Demande de partenariat"
        },
        {
            "image": require("../images/slider1/3.jpg"),
            "title": "Des Solutions D'expert Pour Vous",
            "subtitle": "kompar est une solution pour de nombreux avantages"
        }
    ],
    "about": {
    ...
    "services": [
        {
            "icon": "BsMegaphone",
            "title": "ACQUISITION - TÉLÉVENTE",
            "text": "Télévente, cross selling, up selling, réactivation de contrats, renouvellement..."
        },
        {
            "icon": "MdOutlineHeadsetMic",
            "title": "TÉLÉPROSPECTION",
            "text": "Génération de leads, détection d’opportunités, prise de Rendez-vous, qualification de fichiers, création de trafic sur point de vente"
        },
        {
            "icon": "RiTeamLine",
            "title": "SERVICE CLIENT",
            "text": "Service client, demande de renseignement, hotline technique, SAV Service client, demande de renseignement, hotline technique, SAV"
        },
        {
            "icon": "AiOutlineBarChart",
            "title": "ETUDES MARKETING",
            "text": "enquêtes de satisfaction, sondages, baromètres"
        },
        {
            "icon": "FiTarget",
            "title": "DÉLÉGATION COMPÉTENCES",
            "text": "La garantie de la proximité active avec vos métiers, l’assurance de la synergie des équipes dédiées à vos projets."
        },
        {
            "icon": "FaRegHandshake",
            "title": "FIDÉLISATION -RÉTENTION",
            "text": "Scoring client, cellule de rétention, optimisation des scripts et technique de rétention, campagnes anti-churn"
        }
    ],
    "news": [
        {
