...
function Whyjoin() {
    ...
    const [energy, set_energy] = useState(false);
    const[source,setsource]=useState("https://img.freepik.com/free-photo/high-voltage-power-pylons-green-wheat-field_156373-63.jpg?w=740");

    const handleenergy = (e) => {
        set_energy(!energy)
        setsource("https://img.freepik.com/free-vector/active-people-bikes-windmills-house-with-solar-panel-rooftop-flat-illustration_74855-10477.jpg?t=st=1650843782~exp=1650844382~hmac=ee9ceafc575cd1dbc5dfe3cbec0318b6f8c9ce3faeebb9e4b458cfb81be713df&w=740")
        console.log(1)
    }
